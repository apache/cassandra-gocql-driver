...
Courses in [Scylla University](https://university.scylladb.com/) cover a variety of topics with an emphasis on installing Scylla, Scylla in production and other NoSQL database training concepts – including Scylla DBA training.
