...
// CustomUUIDType is a type to specify in which type the uuid generated by gocql will be
type CustomUUIDType int

// CustomUUIDTypeUUID will generetate a gocql.UUID for the uuid got from cassandra
// CustomUUIDTypeString will generetate a string for the uuid got from cassandra
const (
	CustomUUIDTypeUUID   CustomUUIDType = 0x0000
	CustomUUIDTypeString CustomUUIDType = 0x0001
)

// DefaultUUIDType is the default UUID type used by gocql
var (
...
func goType(t TypeInfo) reflect.Type {
	...
	case TypeUUID, TypeTimeUUID:
		if DefaultUUIDType == CustomUUIDTypeString {
			return reflect.TypeOf(*new(string))
		}
