...
// Slightly complicated semantics, but basically you get two different sizes
// of result sets back from Cassandra depending on whether the CAS
// operation was applied or not.
